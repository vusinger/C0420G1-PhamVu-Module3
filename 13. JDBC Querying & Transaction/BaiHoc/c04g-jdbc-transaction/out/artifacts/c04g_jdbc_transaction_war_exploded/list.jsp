...
<body>
    ...
    <a href="/studentServletPath?actionName=create">Go create new student</a><br>
    <a href="/studentServletPath?actionName=createClassAndStudent">Go create class and student</a>
